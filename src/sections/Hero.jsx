...
export default function Hero() {
  return (
    <section className="relative min-h-[750px] lg:h-screen flex items-center bg-teal py-24 lg:py-0 px-4 md:px-8 lg:px-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        {/* RIGHT COLUMN: Massive Showcase Image Container with Custom Mockup Notch Cutouts */}
        <div className="lg:col-span-7 flex items-center justify-center relative px-2 sm:px-0">
          ...
          <motion.div
            ...
            className="relative w-full aspect-[4/3] sm:aspect-[1.1] rounded-[2.5rem] overflow-hidden border border-gold/20 shadow-[0_20px_50px_rgba(0,0,0,0.65)]"
          >
            <img 
              src="/Hero.jpg" 
              alt="Tava Royal Mughal Platter Special" 
              className="w-full h-full object-cover filter brightness-[1.08] contrast-[1.02] saturate-[1.08]" 
            />
